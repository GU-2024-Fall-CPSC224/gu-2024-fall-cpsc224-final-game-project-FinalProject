...
//             image icon class for images
            ImageIcon pinkIcon = new ImageIcon("project design documents/greenIcon.webp");
            ImageIcon purpleIcon = new ImageIcon("project design documents/blueIcon.webp");
            ImageIcon redIcon = new ImageIcon("project design documents/redIcon.webp");
            ImageIcon yellowIcon = new ImageIcon("project design documents/yellowIcon.webp");
